 ...
 */
export function decodeBoingStorageWordAccountId(valueHex: string): `0x${string}` | null {
  ...
  if (word64 === '0'.repeat(64)) return null;
  return validateHex32(`0x${word64}`) as `0x${string}`;
}
