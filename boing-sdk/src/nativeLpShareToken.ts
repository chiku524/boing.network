...
const LP_SHARE_BALANCE_XOR_U8: Uint8Array = (() => {
 ...
 */
export function lpShareTokenBalanceStorageKeyHex(holderHex32: string): string {
 ...
 */
export async function fetchLpShareTokenBalanceRaw(
  client: BoingClient,
